...
export default function Register() {
  ...
  // NEW: Track password visibility for both fields independently
  ...
  return (
    // UPDATED: Added light mode defaults and dark: variants
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-[#0f172a] px-4 font-sans text-slate-900 dark:text-gray-100 transition-colors duration-300">
      <div className="max-w-md w-full bg-white dark:bg-[#1e293b] rounded-2xl shadow-xl dark:shadow-2xl border border-slate-200 dark:border-slate-800 p-8 transition-colors duration-300">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Join BookShelf</h2>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">Create your free reader account</p>
        </div>
        ...
        <p className="text-center text-sm text-slate-500 dark:text-slate-400 mt-6">
          Already have an account? <Link to="/login" className="text-blue-600 dark:text-blue-500 hover:text-blue-700 dark:hover:text-blue-400 hover:underline transition-colors">Log in here</Link>
        </p>
      </div>
    </div>
  );
