      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            View, promote, and manage system access.
          </p>
        </div>
                ...
                users.map((u) => (
                  ...
                  >
                    <td className="p-5 flex gap-4 items-center border-none">
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold shadow-sm ${u.role === "admin" ? "bg-indigo-500" : "bg-slate-400"}`}
                      >
                    ...
                    <td className="p-5">
                      <span
                        className={`px-2.5 py-1 rounded text-xs font-medium flex items-center gap-1.5 w-max ${
                          u.role === "admin"
